...
<body>
    ...
    <nav>
        ...
        <div class="nav_logo-wrapper">
            <div class="logo">
                <img class="icons" src="images/usuario3.png"><i>Jose Manzo </i>
            </div>
        </div>
    ...
    * {
            ...
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    <div class="perfil-usuario-avatar">
                        <img class="icons" src="images/icon.jpg" alt="img-avatar">
        ...
        <div class="tweet_box">
            <form>
                <div class="tweet_box-input">
                    <img class="icons" src="images/icon.jpg" alt="profile imagw">
    ...
    <aside>
        ...
        <div class="aside_container">
            <h2></h2>
            <img class="Noticias" src="images/usuarioperfil.png" alt="">
