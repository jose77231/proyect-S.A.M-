...
<body>
    ...
    <nav>
        ...
        <div class="nav_logo-wrapper">
            <div class="logo">
                <img class="icons" src="images/LogoUPB.jpg" alt=""><i>@UPB</i>
            </div>
        </div>
        ...
        <section class="seccion-perfil-usuario">
            <div class="perfil-usuario-header">
                <div class="perfil-usuario-portada">
                    <div class="perfil-usuario-avatar">
                        <img class="icons" src="images/LogoUPB.jpg" alt="img-avatar">
            ...
            <div class="perfil-usuario-body">
                <div class="perfil-usuario-bio">
                    <h3 class="titulo">Univerdad Politécnica de Bacalar</h3>
              
                </div>
                <div class="perfil-usuario-footer">
                    <ul class="lista-datos">
                        <li><i class="icono fas fa-map-signs"></i> Dirección :Av 39 77930 Bacalar, México</li>
                        <li><i class="icono fas fa-phone-alt"></i> Teléfono:983 834 2198</li>
                        <li><i class="icono fas fa-briefcase"></i> Página web: upb.edu.mx</li>
                    </ul>
                    <ul class="lista-datos">
                        <li><i class="icono fas fa-map-marker-alt"></i> Correo:upbacalar@upb.edu.mx.</li>
                        <li><i class="icono fas fa-calendar-alt"></i> Redes sociales: Facebock, Instagram,twiter.</li>
                        <li><i class="icono fas fa-user-check"></i> Página:escuela publica</li>
                        <li><i class="icono fas fa-share-alt"></i> Horarios: lunes-viernes.</li>
                    </ul>
                </div>
